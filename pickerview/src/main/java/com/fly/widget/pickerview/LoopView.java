...
public class LoopView extends View {
    ...
    private void initLoopView(Context context) {
        textSize = 0;
        noChooseTextColor = context.getResources().getColor(R.color.black_50);//字体未选中颜色
        chooseTextColor = context.getResources().getColor(R.color.blue_color);//字体选中颜色
        lineColor = context.getResources().getColor(R.color.transparent);//线的颜色
        l = 2.0F;
        isLoop = true;
        positon = -1;
        r = 9;
    ...
    public final void setArrayList(ArrayList<LocationInfo> arraylist) {
        arrayList = arraylist;
        d();
        invalidate();
    }
        ...
        do {
            ...
            while (k1 < r) {
                ...
                if (isLoop) {
                    ...
                    as[k1] = (String) arrayList.get(l1).getLocationName();
                } else if (l1 < 0) {
                    as[k1] = "";
